...
self.addEventListener('push', (event) => {
  ...
  const options = {
    ...
    icon: 'https://ui-avatars.com/api/?name=PV&background=5B2EFF&color=fff&size=192&length=2',
    badge: 'https://ui-avatars.com/api/?name=PV&background=5B2EFF&color=fff&size=96&length=2'
  };
