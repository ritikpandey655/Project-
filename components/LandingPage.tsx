            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
               ...
               <div>
                  ...
                  <div className="flex gap-4 mb-4">
                     {/* Instagram */}
                     <a href="https://instagram.com/learnwithpyqverse" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-gradient-to-br hover:from-purple-600 hover:to-orange-500 hover:text-white transition-all group" aria-label="Instagram">
                     ...
                     {/* Facebook */}
                     <a href="https://www.facebook.com/profile.php?id=100058332954672" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#1877F2] hover:text-white transition-all group" aria-label="Facebook">
                     ...
                     {/* Email (Official) */}
                     <a href="mailto:support@pyqverse.in" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-600 hover:text-white transition-all group" aria-label="Email">
