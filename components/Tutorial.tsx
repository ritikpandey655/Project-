  ...
  const steps = [
    {
      ...
      icon: (
        <div className="w-24 h-24 bg-indigo-100 rounded-full flex items-center justify-center text-5xl mb-6 shadow-inner text-indigo-600 animate-float">
          🤖
        </div>
      )
    },
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white max-w-md w-full rounded-3xl shadow-2xl p-8 flex flex-col items-center text-center animate-fade-in border border-slate-100 relative overflow-hidden">
        ...
        <div className="w-full mt-8 space-y-6 relative z-10">
          ...
          <Button onClick={handleNext} className="w-full py-3 shadow-lg shadow-indigo-200">
