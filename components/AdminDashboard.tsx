            ...
            <div className="flex gap-2 items-center">
                <div className="relative flex-1">
                    <input 
                        ...
                        className={`w-full p-3 pr-20 border rounded-xl dark:bg-slate-900 dark:text-white font-mono text-sm outline-none transition-colors ${groqStatus === 'error' ? 'border-red-500' : 'border-slate-200 dark:border-slate-700'}`}
                    />
